...
<div class="menu-size" style="height:440px;">
    <div class="d-flex mx-3 mt-3 py-1">
        <div class="align-self-center">
            <h1 class="mb-0"> Recharge your Line</h1>
        </div>
    ...
    <div class="content mt-0">
        <div class="form-custom form-label form-icon">
            ...
            <select class="form-select rounded-xs" id="c6" aria-label="Floating label select example">
                ...
                <option selected>GLO </option>
                <option value="1"> 9 MOBILE</option>
            </select>
        ...
        <div class="form-custom form-label form-icon">
            ...
            <input type="number" class="form-control rounded-xs" id="c3" placeholder="0810000012" />
            <label for="c3" class="form-label-always-active color-highlight font-11"> Phone Number</label>
    ...
    <a href="#" data-bs-dismiss="offcanvas" class="mx-3 mb-3 btn btn-full gradient-green shadow-bg shadow-bg-s"> Recharge</a>
</div>
