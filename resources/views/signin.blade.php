  ...
  @endif
       ...
       <div class="card card-style">
           <div class="content">
               ...
               <p>
                   Sign in your 79 Wallet Account
               </p>
               ...
               <div class="d-grid">
               <input type="submit"  value="Log in" class="btn btn-full gradient-highlight shadow-bg shadow-bg-s mt-4">
               </div>
               ...
               <div class="row">
                   ...
                   <div class="col-6 text-end">
                       <a href="{{ route('signup')}}" class="font-11 color-theme opacity-40 pt-4 d-block">Create Account</a>
                   </div>
               </div>
           </div>
       </div>
